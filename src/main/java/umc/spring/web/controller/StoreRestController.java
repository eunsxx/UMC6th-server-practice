...
public class StoreRestController {
    ...
    public ApiResponse<MissionResponseDTO.MissionListDto> getMissionist(@ExistStore @PathVariable(name = "storeId") Long storeId, @RequestParam(name = "page") Integer page) {
